package com.gregory.satokendemo.bizmodel.datasource;

import com.gregory.satokendemo.bizmodel.repository.BaseRepositoryImpl;
...
@EnableJpaRepositories(
    ...
    basePackages = "com.gregory.satokendemo.bizmodel.repository",
...
public class Biz {
  ...
  public LocalContainerEntityManagerFactoryBean bizEntityManagerForTest() {
    ...
    em.setPackagesToScan("com.gregory.satokendemo.bizmodel.model");
